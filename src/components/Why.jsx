...
const cards = [
  ...
  },
  {
    ...
    body: 'The Pear Foods Legume Protein Technology processed legume achieves something that the industry has not achieved: high bioavailability inside a preserved macro structure that mechanistically aligns with pathways known to support satiety and glycemic response.',
  },
  {
    num: '03',
